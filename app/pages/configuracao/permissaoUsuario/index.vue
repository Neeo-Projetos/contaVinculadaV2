<template>
  <div class="min-h-full flex flex-col gap-6 p-4 md:p-8 animate-fade-in text-gray-900 dark:text-gray-100">
    ...
    <AppCabecalhoPagina tituloFino="Gestão de" tituloGrosso="Permissões"
      descricao="Controle de acessos e privilégios dos usuários do sistema" icone="fa7-solid:shield-halved" />

    <AppBarraFerramentas v-model:visao-atual="visaoAtual" mostrar-relatorio>
      <template #entradas>
        <AppInputAutocomplete v-model="filtro.login" urlConsulta="/api/configuracao/permissaoUsuario/autocompleteLogin" propId="descricao" propDescricao="descricao" placeholder="Filtrar por login..." icone="fa7-solid:id-badge" />
        <AppInputAutocomplete v-model="filtro.nomeUsuario" urlConsulta="/api/configuracao/permissaoUsuario/autocompleteUsuario" propId="descricao" propDescricao="descricao" placeholder="Filtrar por nome..." icone="fa7-solid:user" />
      ...
      <template #acoes-pesquisa>
        <AppBotao variacao="acao" icone="fa7-solid:magnifying-glass" @click="buscarUsuarios">
          Pesquisar Usuários
        </AppBotao>
      </template>
    </AppBarraFerramentas>
    ...
    <AppModalExibicao :aberto="modalExibicaoAberto" :colunas="colunasTemp" :labels="labels" @aplicar="aplicarExibicao" @close="modalExibicaoAberto = false" />
